// hide toggle
const PlayButtonToggle = document.querySelector('#play-button-id');
const hideToggle = document.querySelector('.video-player');
PlayButtonToggle.addEventListener('click', () => {
  hideToggle.classList.toggle('video-player-hide');
});
